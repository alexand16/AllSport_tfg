<%-- 
    ...
    Created on : 10 jun 2023, 21:02:35
    Author     : alanr
--%>
    ...
    <body>
        ...
        <div class="container">
            <div class="jumbotron mt-4">
                <h2 class="display-4">Valoraciones de nuestros usuarios:</h2>
                <c:choose>
                    <c:when test="${Valoraciones.size() > 0}">
                        <div class="list-group">
                            <c:forEach items="${Valoraciones}" var="v">
                                <div class="list-group-item d-flex align-items-center justify-content">
                                    <div class="media">
                                        <c:choose>
                                            <c:when test="${v.cliente.rutaImg != '' && v.cliente.rutaImg != null}">
                                                <img src="assets/imgClientes/<c:out value='${v.cliente.rutaImg}'/>" alt="" width="50px" height="50px" class="rounded-circle mr-3">
                                            </c:when>
                                            <c:otherwise>
                                        ...
                                        <div class="media-body">
                                            <h5 class="mt-0"><c:out value='${v.cliente.nombre}'/></h5>
                                            <small><c:out value='${v.fechaValoracion}'/></small>
                                            <div class="star-rating">
                                                <c:forEach begin="1" end="5" var="i">
                                                    <span><c:if test="${i <= v.puntuacion}">&#9733;</c:if><c:if test="${i > v.puntuacion}">&#9734;</c:if></span>
                                                </c:forEach>
                                            </div>
                                        </div>
                                    </div>
                                    <span class="d-flex align-items-center justify-content-between">
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<c:out value='${v.comentario}'/>
                                    </span>
                                </div>
                            </c:forEach>
                        </div>
                        <a href="index.jsp" class="btn btn-secondary mt-4">Volver</a>
                    </c:when>
                    <c:otherwise>
                        <div class="list-group-item">
                            No tenemos valoraciones aún ;( &nbsp;&nbsp;&nbsp;&nbsp; <a href="index.jsp" class="btn btn-secondary mt-4">Volver</a>
                        </div>
                    </c:otherwise>
                </c:choose>
            </div>

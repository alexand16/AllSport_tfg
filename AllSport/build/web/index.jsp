...
<html>
    ...
    <footer class="page-footer" style="background: linear-gradient(50deg, var(--bs-red) 33%, var(--bs-pink));">
        <div class="container">
            <div class="links">
                <a class="nav-link" style="color: rgb(255,255,255)" href="aboutUs.jsp">Sobre Nosotros</a><a class="nav-link" style="color: rgb(255,255,255)" href="Blog">Blog</a><a class="nav-link" style="color: rgb(255,255,255)" href="Tienda">Tienda</a><a class="nav-link" style="color: rgb(255,255,255)" href="Valoraciones">Valoraciones</a><c:if test="${TieneValoracion}"><a class="nav-link" style="color: rgb(255,255,255)" href="usuarioR/Valorar">Deja tu valoración</a></c:if>

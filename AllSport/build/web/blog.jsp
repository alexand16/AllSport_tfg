                        ...
                        <article class="mb-4">
                            <div class="accordion" id="accordion${p.id}">
                                <div class="accordion-item">
                                    ...
                                    <div id="collapse${p.id}" class="accordion-collapse collapse show" aria-labelledby="heading${p.id}" data-bs-parent="#accordion${p.id}">
                                        <div class="accordion-body">
                                            ...
                                            <div class="mb-3">
                                                <form action="usuarioR/CrearRespuesta" method="post">
                                                ...
                                                <c:forEach items="${respuestas}" var="r">
                                                    <c:if test="${p.id == r.post.id}">
                                                        ...
                                                        <p class="encabezado-respuesta">
                                                            Publicado el <c:out value="${r.fechaCreacion}"/> por <strong><c:out value="${r.usuario.nombre}"/></strong>&nbsp
                                                            <c:choose>

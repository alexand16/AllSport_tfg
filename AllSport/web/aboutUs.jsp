<%-- 
    Document   : aboutUs
    Created on : 2 jun 2023, 12:33:36
    Author     : alanr
--%>
...
<html lang="en">
    ...
    <head>
        ...
        <title>Acerca de nosotros - AllSport Gym</title>
    ...
    <body>
        ...
        <section class="py-5">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <h2>¡Bienvenido a AllSport Gym!</h2>
                        <p>Somos un gimnasio comprometido en brindar a nuestros clientes una experiencia única y satisfactoria.</p>
                        <p>En AllSport Gym, valoramos a nuestros clientes y nos esforzamos por ofrecerles un ambiente amigable y
                            motivador donde puedan alcanzar sus metas de salud y bienestar.</p>
                        <p>Nuestro equipo de profesionales capacitados está listo para ayudarte en cada paso del camino, ya sea que
                            quieras perder peso, ganar músculo o simplemente mantenerte en forma.</p>
                    </div>
                    <div class="col-md-6">
                        <img src="assets/img/gym-image.jpg" height="450" width="500" alt="AllSport Gym">
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <ul>
                            ...
                            <li>Área de musculación y cardio</li>
                            <li>Piscina y spa</li>
                    ...
                    <div class="col-md-6">
                        ...
                        <p>En AllSport Gym, no solo te ayudamos a mantenerte en forma, también te brindamos la oportunidad de
                            relacionarte con personas afines y ser parte de una comunidad activa y saludable.</p>
                        <p>¡Ven y descubre todo lo que tenemos para ofrecerte!</p>
                        <a href="https://api.whatsapp.com/send?phone=652982078" class="btn btn-primary">Contáctanos</a>
                    </div>
                </div>
            </div>
        </section>
